    ...
    <div className={styles.stepContainer}>
      ...
      <div className={styles.inputGridWrapper}>
        <div className={styles.inputGrid}>
          ...
          <div className={styles.formGroup}>
            ...
            <select
              ...
              onChange={(e) =>
                handleFrequencyChange(e.target.value as PaymentFrequency)
              }
              disabled={isLoading}
            ...
            <p className={styles.inputHelper}>
              Determines the cycle and term units
            </p>
          </div>
          ...
          <div className={styles.formGroup}>
            ...
            <p className={styles.inputHelper}>
              ...
              {state.frequency === "bi-monthly"
                ? "payouts"
                : state.frequency || "units"}
            </p>
          </div>
          ...
          <div className={styles.formGroup}>
            ...
            />
            <p className={styles.inputHelper}>
              First payment date (tomorrow or later)
            </p>
          </div>
        </div>
        ...
        <InfoBox variant="lightbulb">
          Choose your frequency first, then specify the term. We'll
          automatically calculate the schedule based on these units.
        </InfoBox>
      </div>
        ...
        <SummaryCard
          ...
          items={[
            ...
            },
            {
              label: "Frequency:",
              value: state.frequency
                ? state.frequency.charAt(0).toUpperCase() +
                  state.frequency.slice(1)
                : "—",
            },
            {
              label: "Term:",
            ...
            ...(state.startDate
              ? [{ label: "Start Date:", value: formatDate(state.startDate) }]
              : []),
          ]}
        />
      </div>
