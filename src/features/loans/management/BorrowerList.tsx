...
export default function BorrowerList({
  ...
  if (loading) {
    return <LoadingState message="Synchronizing collections database..." />;
  }
        ...
        >
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm mt-1">
              We couldn't find any borrowers matching "{searchQuery}"
            </p>
          </div>
        </Card>
      ) : (
        <div className="grid grid-cols-1 gap-3">
          <h3 className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mb-2 px-1">
            Master Records ({filteredBorrowers.length})
          </h3>
            ...
            >
              <div className="flex items-center p-4 sm:p-5">
                ...
                <div className="ml-4 flex-1">
                  <h4 className="font-bold text-gray-900 group-hover:text-main-blue transition-colors truncate">
                    {borrower.full_name}
                  </h4>
                  <div className="flex items-center gap-3 text-xs font-medium text-gray-500 mt-1">
                    ...
                    <span className="text-blue-600/60 font-bold uppercase tracking-tighter">
                      View Account
                    </span>
                  </div>
                </div>
